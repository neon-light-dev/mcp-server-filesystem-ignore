...
- If the job logs show an older npm version such as `10.x`, upgrade npm in the workflow before `npm publish` or trusted publishing may fail with a misleading registry error.
